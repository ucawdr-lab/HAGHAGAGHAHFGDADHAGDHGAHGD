...
local run = function(func)
	...
	if not ok then warn('[GRIEFER] Bedwars module skipped: '..tostring(err)) end
end
...
run(function()
	...
	local packages = (function() local ok,r = pcall(function() return httpService:JSONDecode(downloadFile('newvape/profiles/packages.json')) end) return ok and r or {remotes = {}} end)()	
